# Generated by Django 3.0.2 on 2020-05-10 21:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facebook_id', models.CharField(max_length=250, null=True, unique=True, verbose_name='ID de Facebook')),
                ('profile_picture', models.ImageField(blank=True, upload_to='images/users', verbose_name='Foto de perfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colony', models.CharField(max_length=255, verbose_name='Colonia / Asentamiento')),
                ...
                ('between_street2', models.CharField(blank=True, max_length=255, verbose_name='Calle 1')),
                ('telephone', models.CharField(max_length=20, verbose_name='Teléfono de contacto')),
                ('references', models.TextField(max_length=500, verbose_name='Indicaciones adicionales para entregar tus compras en esta dirección')),
